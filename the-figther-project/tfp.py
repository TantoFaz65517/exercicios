...
#KO = pygame.mixer.music.load("the-figther-project/audio/KO.mp3")
#fight = pygame.mixer.music.load("the-figther-project/audio/fight!.mp3")
# Fundo do jogo
janela.fill("black")
...
while loop:
    ...
    if fim_de_round == False:
        ...
        janela.blit(vitoria_img, (290, 120))
